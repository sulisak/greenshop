                                            ...
                                            <tbody>
                                                <tr style="font-size: 20px;">
                                                    ...
                                                    <td align="right" style="font-weight: bold;"><?= $lang_qty ?>
                                                        {{Sumsalenum() | number }}</td>
                                                    <td align="right" style="font-weight: bold;">ລວມເງິນເດິ້
                                                        <span style="color: red">{{Sumsalepricevat() | number }}</span>
                                                        <?= $lang_currency ?>
                                                    </td>
                                                    <td></td>
                                    ...
                                    <div class="modal-body text-center">
                                        ...
                                        <center>
                                            ...
                                            <button ng-show="printer_ul =='0'" class="btn btn-primary btn-lg"
                                                ...
                                                ng-click="printDivmini()"><?= $lang_billmini ?>(Slip 55)</button>
 ...
 -->
                                        ...
                                        <table style="width: 100%;font-size: 25px;">
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: left;">ລວມເງິນເດີ້</td>
                                                <td></td>
                                                    ...
                                                    <tbody>
                                                        <tr ng-repeat="x in list">
                                                            ...
                                                            <td>
                                                                ...
                                                                <button ng-show="printer_ul !='0'"
                                                                    class="btn btn-primary btn-sm"
                                                                    ng-click="printDivminiip2(x)">print slip</button>
